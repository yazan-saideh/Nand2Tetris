...
def analyze_file(
    ...
    Args:
        ...
        output_file (typing.TextIO): writes all output.txt to this file.
    """
    # Your code goes here!
...
if "__main__" == __name__:
    ...
    # This opens both the input and the output.txt files!
    # Both are closed automatically when the code finishes running.
    # If the output.txt file does not exist, it is created automatically in the
